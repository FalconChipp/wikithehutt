...
export const Head = () => <title>Savage Opress</title>
export default function SavageOpress({data, location}) {
    return (
        <Layout>
            <section className="w-full grid">
                <Breadcrumb location={location} crumbLabel="Savage Opress"></Breadcrumb>
                <h1 className="text-white text-center font-jedi text-6xl pt-5 pb-10">Savage Opress</h1>
