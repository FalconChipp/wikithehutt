...
export const Head = () => <title>Grogu</title>
export default function Grogu({data, location}) {
    return (
        <Layout>
            <section className="w-full grid">
                <Breadcrumb location={location} crumbLabel="The bestest boi"></Breadcrumb>
                <h1 className="text-white text-center font-jedi text-6xl pt-5 pb-10">Grogu</h1>
                <div className="grid grid-cols-2 gap-5 container-center">
                    <div>
                        <GatsbyImage image={data.grogu.childImageSharp.gatsbyImageData} alt="grogu"/>
                    </div>
