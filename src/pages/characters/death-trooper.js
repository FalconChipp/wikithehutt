...
export const Head = () => <title>Death Trooper</title>
export default function DeathTrooper({data, location}) {
    return (
        <Layout>
            <section className="w-full grid">
                <Breadcrumb location={location} crumbLabel="Death Trooper"></Breadcrumb>
                <h1 className="text-white text-center font-jedi text-6xl pt-5 pb-10">Death Trooper</h1>
