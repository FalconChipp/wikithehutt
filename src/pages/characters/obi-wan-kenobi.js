...
export const Head = () => <title>Obi Wan Kenobi</title>
export default function ObiWanKenobi({data, location}) {
    return (
        <Layout>
            <section className="w-full grid">
                <Breadcrumb location={location} crumbLabel="Obi-Wan Kenobi"></Breadcrumb>
                ...
                <div className="grid grid-cols-2 gap-5 container-center">
                    <div>
                        <GatsbyImage image={data.obiwan.childImageSharp.gatsbyImageData} alt="obi wan"/>
                    </div>
