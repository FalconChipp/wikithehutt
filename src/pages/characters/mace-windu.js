...
export const Head = () => <title>Mace Windu</title>
export default function MaceWindu({data, location}) {
    return (
        <Layout>
            <section className="w-full grid">
                <Breadcrumb location={location} crumbLabel="Mace Windu"></Breadcrumb>
                <h1 className="text-white text-center font-jedi text-6xl pt-5 pb-10">Mace Windu</h1>
                <div className="grid grid-cols-2 gap-5 container-center">
                    <div>
                        <GatsbyImage image={data.macewindu.childImageSharp.gatsbyImageData} alt="mace windu"/>
                    </div>
