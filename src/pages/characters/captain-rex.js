...
export const Head = () => <title>Captain Rex</title>
export default function CaptainRex({data, location}) {
    return (
        <Layout>
            <section className="w-full grid">
                <Breadcrumb location={location} crumbLabel="Captain Rex"></Breadcrumb>
                <h1 className="text-white text-center font-jedi text-6xl pt-5 pb-10">Captain Rex</h1>
                <div className="grid grid-cols-2 gap-5 container-center">
                    <div>
                        <GatsbyImage image={data.captainrex.childImageSharp.gatsbyImageData} alt="rex"/>
                    </div>
