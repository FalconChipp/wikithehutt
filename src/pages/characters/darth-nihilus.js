...
export const Head = () => <title>Darth Nihilus</title>
export default function Nihilus({data, location}) {
    return (
        <Layout>
            <section className="w-full grid">
                <Breadcrumb location={location} crumbLabel="Darth Nihilus"></Breadcrumb>
                <h1 className="text-white text-center font-jedi text-6xl pt-5 pb-10">Darth Nihilus</h1>
                <div className="grid grid-cols-2 gap-5 container-center">
                    <div>
                        <GatsbyImage image={data.darthnil.childImageSharp.gatsbyImageData} alt="darthnil"/>
                    </div>
