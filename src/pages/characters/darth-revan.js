...
export const Head = () => <title>Darth Revan</title>
export default function Revan({data, location}) {
    return (
        <Layout>
            <section className="w-full grid">
                <Breadcrumb location={location} crumbLabel="Darth Revan"></Breadcrumb>
                <h1 className="text-white text-center font-jedi text-6xl pt-5 pb-10">Darth Revan</h1>
                <div className="grid grid-cols-2 gap-5 container-center">
                    <div>
                        <GatsbyImage image={data.darthrevan.childImageSharp.gatsbyImageData} alt="revan"/>
                    </div>
