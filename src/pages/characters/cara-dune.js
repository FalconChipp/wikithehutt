...
export const Head = () => <title>Cara Dune</title>
export default function CaraDune({data, location}) {
    return (
        <Layout>
            <section className="w-full grid">
                <Breadcrumb location={location} crumbLabel="Cara Dune"></Breadcrumb>
                <h1 className="text-white text-center font-jedi text-6xl pt-5 pb-10">Cara Dune</h1>
