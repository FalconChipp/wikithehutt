...
export const Head = () => <title>Darth Malgus</title>
export default function Malgus({data, location}) {
    return (
        <Layout>
            <section className="w-full grid">
                <Breadcrumb location={location} crumbLabel="Darth Malgus"></Breadcrumb>
                <h1 className="text-white text-center font-jedi text-6xl pt-5 pb-10">Darth Malgus</h1>
                <div className="grid grid-cols-2 gap-5 container-center">
                    <div>
                        <GatsbyImage image={data.darthmalgus.childImageSharp.gatsbyImageData} alt="malgus"/>
                    </div>
