...
export default function DarthSidous({data}) {
    return (
        <Layout>
            <section className="w-full grid">
                ...
                <div className="grid grid-cols-2 gap-5 container-center">
                    <div>
                        <GatsbyImage image={data.darthsidious.childImageSharp.gatsbyImageData} alt="darth sidious"/>
                    </div>
