...
export const Head = () => <title>First Order Executioner</title>
export default function FirstOrderExec({data, location}) {
    return (
        <Layout>
            <section className="w-full grid">
                <Breadcrumb location={location} crumbLabel="First Order Excecutioner"></Breadcrumb>
                <h1 className="text-white text-center font-jedi text-6xl pt-5 pb-10">First Order Executioner</h1>
                <div className="grid grid-cols-2 gap-5 container-center">
                    <div>
                        <GatsbyImage image={data.firstorderex.childImageSharp.gatsbyImageData} alt="first order ex"/>
                    </div>
