...
export const Head = () => <title>General Hux</title>
export default function Hux({data, location}) {
    return (
        <Layout>
            <section className="w-full grid">
                <Breadcrumb location={location} crumbLabel="General Hux"></Breadcrumb>
                <h1 className="text-white text-center font-jedi text-6xl pt-5 pb-10">General Hux</h1>
