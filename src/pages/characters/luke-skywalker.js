...
export const Head = () => <title>Luke Skywalker</title>
export default function LukeSkywalker({data, location}) {
    return (
        <Layout>
            <section className="w-full grid">
                <Breadcrumb location={location} crumbLabel="Luke Skywalker"></Breadcrumb>
                <h1 className="text-white text-center font-jedi text-6xl pt-5 pb-10">Luke Skywalker</h1>
