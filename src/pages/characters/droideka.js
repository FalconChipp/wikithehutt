...
export const Head = () => <title>Droideka</title>
export default function Droideka({data, location}) {
    return (
        <Layout>
            <section className="w-full grid">
                <Breadcrumb location={location} crumbLabel="Droideka"></Breadcrumb>
                <h1 className="text-white text-center font-jedi text-6xl pt-5 pb-10">Droideka</h1>
                <div className="grid grid-cols-2 gap-5 container-center">
                    <div>
                        <GatsbyImage image={data.droideka.childImageSharp.gatsbyImageData} alt="droideka"/>
                    </div>
