...
export const Head = () => <title>Bo-Katan Kryze</title>
export default function BoKatan({data, location}) {
    return (
        <Layout>
            <section className="w-full grid">
                <Breadcrumb location={location} crumbLabel="Bo-Katan Kryze"></Breadcrumb>
                <h1 className="text-white text-center font-jedi text-6xl pt-5 pb-10">Bo-Katan Kryze</h1>
                <div className="grid grid-cols-2 gap-5 container-center">
                    <div>
                        <GatsbyImage image={data.bokatan.childImageSharp.gatsbyImageData} alt="bokatan"/>
                    </div>
