...
export const Head = () => <title>Snoke</title>
export default function Snoke({data, location}) {
    return (
        <Layout>
            <section className="w-full grid">
                <Breadcrumb location={location} crumbLabel="Snoke"></Breadcrumb>
                <h1 className="text-white text-center font-jedi text-6xl pt-5 pb-10">Snoke</h1>
                <div className="grid grid-cols-2 gap-5 container-center">
                    <div>
                        <GatsbyImage image={data.snoke.childImageSharp.gatsbyImageData} alt="snoke"/>
                    </div>
