...
export const Head = () => <title>Assajj Ventress</title>
export default function AssajjVentress({data, location}) {
    return (
        <Layout>
            <section className="w-full grid">
                <Breadcrumb location={location} crumbLabel="Assajj Ventress"></Breadcrumb>
                <h1 className="text-white text-center font-jedi text-6xl pt-5 pb-10">Assajj Ventress</h1>
                <div className="grid grid-cols-2 gap-5 container-center">
                    <div>
                        <GatsbyImage image={data.assajj.childImageSharp.gatsbyImageData} alt="assajj" loading="eager"/>
                    </div>
