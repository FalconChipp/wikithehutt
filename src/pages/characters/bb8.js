    ...
    return (
        <Layout>
            <section className="w-full grid">
                <Breadcrumb location={location} crumbLabel="BB8"></Breadcrumb>
                <h1 className="text-white text-center font-jedi text-6xl pt-5 pb-10">BB-8</h1>
                <div className="grid grid-cols-2 gap-5 container-center">
                    <div>
                        <GatsbyImage image={data.bb8.childImageSharp.gatsbyImageData} alt="bb8"/>
                    </div>
