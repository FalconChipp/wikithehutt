...
export const Head = () => <title>Darth Talon</title>
export default function Talon({data, location}) {
    return (
        <Layout>
            <section className="w-full grid">
                <Breadcrumb location={location} crumbLabel="Darth Talon"></Breadcrumb>
                <h1 className="text-white text-center font-jedi text-6xl pt-5 pb-10">Darth Talon</h1>
                <div className="grid grid-cols-2 gap-5 container-center">
                    <div>
                        <GatsbyImage image={data.darthtalon.childImageSharp.gatsbyImageData} alt="talon"/>
                    </div>
