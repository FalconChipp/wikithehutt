...
export const Head = () => <title>Grand Moff Gideon</title>
export default function MoffGideon({data, location}) {
    return (
        <Layout>
            <section className="w-full grid">
                <Breadcrumb location={location} crumbLabel="Moff Geideon"></Breadcrumb>
                <h1 className="text-white text-center font-jedi text-6xl pt-5 pb-10">Grand Moff Gideon</h1>
                <div className="grid grid-cols-2 gap-5 container-center">
                    <div>
                        <GatsbyImage image={data.moff.childImageSharp.gatsbyImageData} alt="moff"/>
                    </div>
