    ...
    return (
        <Layout>
            <section className="w-full grid">
                <Breadcrumb location={location} crumbLabel="Gamorrean Guard"></Breadcrumb>
                <h1 className="text-white text-center font-jedi text-6xl pt-5 pb-10">Gamorrean Guard</h1>
                <div className="grid grid-cols-2 gap-5 container-center">
                    <div>
                        <GatsbyImage image={data.gamguardnew.childImageSharp.gatsbyImageData} alt="gam guard"/>
                    </div>
