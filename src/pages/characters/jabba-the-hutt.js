...
export const Head = () => <title>Jabba The Hutt</title>
export default function Jabba({data, location}) {
    return (
        <Layout>
            <section className="w-full grid">
                <Breadcrumb location={location} crumbLabel="Jabba The Hutt"></Breadcrumb>
                <h1 className="text-white text-center font-jedi text-6xl pt-5 pb-10">Jabba The Hutt</h1>
                <div className="grid grid-cols-2 gap-5 container-center">
                    <div>
                        <GatsbyImage image={data.jabbahutt.childImageSharp.gatsbyImageData} alt="jabba hutt"/>
                    </div>
