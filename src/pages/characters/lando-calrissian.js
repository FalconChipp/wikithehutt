...
export const Head = () => <title>Lando Calrissian</title>
export default function LandoCalrissian({data, location}) {
    return (
        <Layout>
            <section className="w-full grid">
                <Breadcrumb location={location} crumbLabel="Lando Calrissian"></Breadcrumb>
                <h1 className="text-white text-center font-jedi text-6xl pt-5 pb-10">Lando Calrissian</h1>
                <div className="grid grid-cols-2 gap-5 container-center">
                    <div>
                        <GatsbyImage image={data.lando.childImageSharp.gatsbyImageData} alt="lando"/>
                    </div>
