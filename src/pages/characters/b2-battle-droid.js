...
export const Head = () => <title>B2 Super Battle Droid</title>
export default function B2Droid({data, location}) {
    return (
        <Layout>
            <section className="w-full grid">
                <Breadcrumb location={location} crumbLabel="B2 Battle Dorid"></Breadcrumb>
                <h1 className="text-white text-center font-jedi text-6xl pt-5 pb-10">B2 Super Battle Droid</h1>
                <div className="grid grid-cols-2 gap-5 container-center">
                    <div>
                        <GatsbyImage image={data.b2battledroid.childImageSharp.gatsbyImageData} alt="b2battledroid"/>
                    </div>
