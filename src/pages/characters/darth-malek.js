...
export const Head = () => <title>Darth Malek</title>
export default function Malek({data, location}) {
    return (
        <Layout>
            <section className="w-full grid">
                <Breadcrumb location={location} crumbLabel="Darth Malek"></Breadcrumb>
                <h1 className="text-white text-center font-jedi text-6xl pt-5 pb-10">Darth Malek</h1>
                <div className="grid grid-cols-2 gap-5 container-center">
                    <div>
                        <GatsbyImage image={data.darthmalek.childImageSharp.gatsbyImageData} alt="malek"/>
                    </div>
