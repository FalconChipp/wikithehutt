...
export const Head = () => <title>B1 Battle Droid</title>
export default function B1Droid({data, location}) {
    return (
        <Layout>
            <section className="w-full grid">
                <Breadcrumb location={location} crumbLabel="B1 Battle Droid"></Breadcrumb>
                <h1 className="text-white text-center font-jedi text-6xl pt-5 pb-10">B1 Battle Droid</h1>
                <div className="grid grid-cols-2 gap-5 container-center">
                    <div>
                        <GatsbyImage image={data.b1droid.childImageSharp.gatsbyImageData} alt="b1droid"/>
                    </div>
