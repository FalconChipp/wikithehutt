...
export const Head = () => <title>Dreadnaught</title>
export default function Dreadnaught({data}) {
    return (
        <Layout>
            <section className="w-full grid">
                <h1 className="text-white text-center font-jedi text-6xl pt-5 pb-10">Dreadnaught</h1>
                ...
                <Slice alias="dreadnaughtContent" />
            </section>
        </Layout>
    );
}
