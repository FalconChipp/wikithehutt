...
export const Head = () => <title>Tie Fighter</title>
export default function TieFighter({data}) {
    return (
        <Layout>
            <section className="w-full grid">
                <h1 className="text-white text-center font-jedi text-6xl pt-5 pb-10">Tie Fighter</h1>
