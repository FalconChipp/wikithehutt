...
export const Head = () => <title>BTL Y-Wing</title>
export default function BTLYWing({data}) {
    return (
        <Layout>
            <section className="w-full grid">
                <h1 className="text-white text-center font-jedi text-6xl pt-5 pb-10">BTL Y-Wing</h1>
                <div className="grid grid-cols-2 gap-5 container-center">
                    <div>
                        <GatsbyImage image={data.btlywing.childImageSharp.gatsbyImageData} alt="ywing"/>
                    </div>
