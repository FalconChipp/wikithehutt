...
export const Head = () => <title>Tie Interceptor</title>
export default function TieInterceptor({data}) {
    return (
        <Layout>
            <section className="w-full grid">
                <h1 className="text-white text-center font-jedi text-6xl pt-5 pb-10">Tie Interceptor</h1>
                <div className="grid grid-cols-2 gap-5 container-center">
                    <div>
                        <GatsbyImage image={data.theinterceptor.childImageSharp.gatsbyImageData} alt="inceptor"/>
                    </div>
