...
export const Head = () => <title>The Death Star</title>
export default function DeathStar({data}) {
    return (
        <Layout>
            <section className="w-full grid">
                <h1 className="text-white text-center font-jedi text-6xl pt-5 pb-10">The Death Star</h1>
                <div className="grid grid-cols-2 gap-5 container-center">
                    <div>
                        <GatsbyImage image={data.deathstar.childImageSharp.gatsbyImageData} alt="Thats no moon"/>
                    </div>
